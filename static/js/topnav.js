...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    container.innerHTML = `
      <nav class="top-nav">
        <ul>
          <li><a href="/today" class="nav-link" data-path="/">Home</a></li>
          <li><a href="/live" class="nav-link" data-path="/live">Live</a></li>
          <li><a href="/leagues" class="nav-link" data-path="/leagues">Leagues</a></li>
          <li><a href="/" class="nav-link" data-path="/heatmap">HeatMap</a></li>
